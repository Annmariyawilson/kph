    ...
    extend: {
      ...
      colors: {
        ...
        paint: {
          ...
          sky: "hsl(var(--paint-sky))",
          sage: "hsl(var(--paint-sage))",
          blush: "hsl(var(--paint-blush))",
      ...
      keyframes: {
        ...
        "tin-float": {
          ...
          "50%": {
            ...
            filter: "drop-shadow(0 50px 60px rgba(0,0,0,0.35))"
          },
        },
        "float-circular": {
      ...
      animation: {
        ...
        "fade-up": "fade-up(30px) 0.8s ease-out forwards",
        "fade-in": "fade-in 3s ease-out forwards",
        float: "float 60s ease-in-out infinite",
        "tin-float": "tin-float 37s ease-in-out infinite",
        "float-circular": "float-circular 43s ease-in-out infinite",
